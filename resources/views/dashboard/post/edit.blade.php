    ...
    <form method="post" action="/dashboard/post/{{ $post->slug }}" class="mb-5">
      @method('put')
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error ('nama_laptop') is-invalid @enderror" id="nama_laptop" name="nama_laptop" placeholder="Nama Barang" required autofocus value="{{ old('nama_laptop', $post->nama_laptop) }}">
          @error('nama_laptop')
